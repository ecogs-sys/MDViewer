...
[![Latest Release](https://img.shields.io/github/v/release/ecogs-sys/MDViewer?label=latest)](https://github.com/ecogs-sys/MDViewer/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/ecogs-sys/MDViewer/total?label=downloads)](https://github.com/ecogs-sys/MDViewer/releases)
...
<table>
  <tr>
    <td align="center">
      <a href="https://github.com/ecogs-sys/MDViewer/releases/latest/download/MDViewer-windows-setup.exe">
        <strong>⬇ Windows</strong><br/>
        <sub><code>MDViewer-windows-setup.exe</code></sub>
      </a>
    </td>
    <td align="center">
      <a href="https://github.com/ecogs-sys/MDViewer/releases/latest/download/MDViewer-mac.dmg">
        <strong>⬇ macOS</strong><br/>
        <sub><code>MDViewer-mac.dmg</code></sub>
      </a>
    </td>
    <td align="center">
      <a href="https://github.com/ecogs-sys/MDViewer/releases/latest/download/MDViewer-linux.AppImage">
        <strong>⬇ Linux</strong><br/>
        <sub><code>MDViewer-linux.AppImage</code></sub>
      </a>
    </td>
  </tr>
</table>

[All releases & changelog →](https://github.com/ecogs-sys/MDViewer/releases)
...
| Platform | Artifact |
|---|---|
| Windows | `release/<version>/MDViewer-windows-setup.exe` (NSIS installer) <br> `release/<version>/win-unpacked/MDViewer.exe` (portable, no install) |
